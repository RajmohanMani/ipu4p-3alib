...
#ifndef _ICAMERA_ISP_CONTROL_H_
#define _ICAMERA_ISP_CONTROL_H_
...
typedef enum
{
    ...
    camera_control_isp_ctrl_id_color_correction_matrix = 12052,
    camera_control_isp_ctrl_id_advanced_color_correction_matrix = 5166,
    ...
    camera_control_isp_ctrl_id_bnlm = 47774,
    camera_control_isp_ctrl_id_tnr5_21 = 20429,
    camera_control_isp_ctrl_id_xnr_dss = 22233,
    camera_control_isp_ctrl_id_gamma_tone_map = 2961,
...
struct camera_control_isp_gamma_tone_map_t
{
    /*!< gamma[1024] Gamma table for all channels*/
    float gamma[1024];
    /*!< gamma_lut_size Gamma LUT size*/
    int32_t gamma_lut_size;
    /*!< tone_map[1024] Tone map for all channels*/
    float tone_map[1024];
    /*!< tone_map_lut_size Tone map LUT size*/
    int32_t tone_map_lut_size;
