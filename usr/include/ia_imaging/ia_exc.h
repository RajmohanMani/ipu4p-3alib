 ...
 */
LIBEXPORT ia_err
ia_exc_analog_gain_to_sensor_units_v2(
    const cmc_analog_gain_conversion2_t *gain_conversion,
 ...
 */
LIBEXPORT ia_err
ia_exc_sensor_units_to_analog_gain_v2(
    const cmc_analog_gain_conversion2_t *gain_conversion,
 ...
 */
LIBEXPORT ia_err
ia_exc_get_analog_gain_code_v2(
    const cmc_analog_gain_conversion2_t *gain_conversion,
    const unsigned short gain_code,
 ...
 */
LIBEXPORT ia_err
ia_exc_convert_iso_to_gains_v2(
    const cmc_analog_gain_conversion2_t *analog_gain_conversion,
 ...
 */
LIBEXPORT ia_err
ia_exc_convert_gain_codes_to_iso_v2(
    const cmc_analog_gain_conversion2_t *analog_gain_conversion,
    const cmc_parsed_digital_gain_t *digital_gain_conversion,
    const cmc_sensitivity_t *sensitivity,
