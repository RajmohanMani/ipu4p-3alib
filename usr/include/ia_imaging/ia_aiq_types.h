...
typedef struct
{
    ...
    unsigned int total_target_exposure;     /*!< Total exposure ie. combination of Et, Ag, Dg, Aperture gain and ND gain, -1 if N/A. */
...
typedef struct {
    ...
    cmc_media_format media_format;                              /*!< Color space in which Advanced CC matrices are tuned (and to be used). */
